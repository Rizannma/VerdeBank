...
<head>
    ...
    <body>
        <div class="deposit-sc">
        <div class="greetings">Boost Your Account Balance</div>
        <div class="subheading">
            Easily deposit funds from external source into your Verde Bank
            account—quick, secure, and hassle-free.
        </div>
        <div class="subheading2">Choose your payment method.</div>
...
<!-- Payment -->
  ...
  <script>
    ...
    if (selectedCard) {
      window.location.href = 'user_deposit_form.php';
    } else {
